...
const DoctorsList = () => {
  ...
  const {doctors , adminToken ,getAllDoctors, changeAvailiability} = useContext(AdminContext)
            ...
            <div key={index} className='border border-indigo-200 rounded-xl max-w-56 overflow-hidden group'>
              ...
              <div className='p-4'>
                ...
                <div className='mt-2 flex items-center gap-1 text-sm'>
                  <input onChange={()=>changeAvailiability(item._id)} type="checkbox" checked={item.available} />
                  <p>Available</p>
                </div>
              </div>
            </div>
